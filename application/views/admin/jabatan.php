                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $data['jabat'] = $this->db->get('jabat')->result_array();
                                foreach ($data['jabat'] as $k) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a class="btn btn-xs btn-warning" href="aksi_hapus.php?id=<?php echo $k['id']; ?>" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA <?php echo $k['nm_jabatan']; ?>	?')">
